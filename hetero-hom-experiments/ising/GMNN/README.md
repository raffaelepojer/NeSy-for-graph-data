# Fork form the original repository

We used this repository to train the GMNN models and compare the results. We include the Ising data in the ```semisupervised``` folder.
...
=================
<!--ts-->
- [Fork form the original repository](#fork-form-the-original-repository)
- [GMNN](#gmnn)
