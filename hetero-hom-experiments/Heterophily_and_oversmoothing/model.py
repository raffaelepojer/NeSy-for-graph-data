...
class GGCN_prim(nn.Module):
    def __init__(self, nfeat, nlayers, nhidden, nclass, dropout, decay_rate, exponent, use_degree=True, use_sign=True, use_decay=True, use_sparse=False, scale_init=0.5, deg_intercept_init=0.5, use_bn=False, use_ln=False, generated=False, pre_features=True, primula=False):
        super(GGCN_prim, self).__init__()
        self.dropout = dropout
        self.convs = nn.ModuleList()
        if use_sparse:
