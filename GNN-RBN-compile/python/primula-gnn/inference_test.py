...
# Be aware of the device (CPU or GPU) on which the model was trained and where you are loading the weights. 
# If the devices are different, you may need to map the location of the weights to the appropriate device using the map_location argument in torch.load().
models_info = {
    ...
    "gnnGraph1": (MYACRGnnGraph, "/Users/lz50rg/Dev/GNN-RBN-workspace/GNN-RBN-reasoning/models/triangle_16_10_8_20240222-104544/RBN_graph_triangle_16_10_8.pt", 
            {
                "input_dim": 7,
                "hidden_dim": [16, 10, 8],
                "num_layers": 3,
